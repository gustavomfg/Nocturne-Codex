...
interface Props { suggestions: Suggestion[]; onStatus(suggestion: Suggestion, status: SuggestionStatus): void; onApply(suggestion: Suggestion): void; onOpenFile(filePath: string): void; onNotify(value: string): void }
...
export function SuggestionsPanel({ suggestions, onStatus, onApply, onOpenFile, onNotify }: Props) {
